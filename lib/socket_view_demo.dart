              ...
              return Center(
                child: isLoading.value
                    ...
                    : Column(
                        ...
                        children: [
                          Text(socketManager.socket?.connected ?? false
                              ? 'Socket Connected'
                              : 'Socket Not Connected'),
                          const SizedBox(
                            height: 10,
                          ),
                          Text(socketManager.socketError == ""
                              ? ''
                              : 'Socket Error:- ${socketManager.socketError}'),
                          ...
                          ElevatedButton(
                              onPressed: () async {
                                if (socketManager.socket?.disconnected ??
                                  ...
                                  socketManager
                                      .connect("<Your URL With Port Number>");
                          ...
                          ElevatedButton(
                              onPressed: () {
                                socketManager.socket?.on('<Your Event>',
                                    (data) => print('---$data'));
                                setState(() {});
                              },
